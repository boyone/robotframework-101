...
${CONFIRM_PAYMENT_TEMPLATE}    {"order_id": 8004359104,"payment_type": "credit","type": "visa","card_number": "4719700591590995","cvv": "752","expired_month": 7,"expired_year": 20,"card_name": "Karnwat Wongudom","total_price": 14.95}
...
Get Product List
    ...
    Log List   ${products}
    ${product}=    Find Product By Name    ${products}    43 Piece dinner Set
    Should Be True     ${product["id"]} != 0    product id should not equal 0
